...
class Auth extends Component {
    ...
    uploadImage.on('state_changed',
      ...
      () =>
        storage.ref('multiuser').child(currentImageName).getDownloadURL().then(url => {
          ...
          axios.post('https://sleepy-retreat-07400.herokuapp.com/api/update/' + this.state.fetched._id, regObj)
            .then((res) => {
  ...
  componentDidMount() {
    axios.get('https://sleepy-retreat-07400.herokuapp.com/api', { headers: this.state.headers })
      .then(res => {
        ...
        axios.get('https://sleepy-retreat-07400.herokuapp.com/api/user/loggeduser/' + this.state.fetched._id)
          .then(res => {
            if (res.data) {
              this.setState({
            ...
            console.log("arrayobj0", arrayObj);

            axios.post('https://sleepy-retreat-07400.herokuapp.com/api/newsfeed', arrayObj)
              .then(res => {
                if (res.data) {
                  this.setState({
                    newsfeed: res.data
  ...
  render() {
    ...
    return (
      <div style={{
        backgroundImage: `url(https://i.ytimg.com/vi/I9RbClQ_2Wg/maxresdefault.jpg)`,
